...
# \*   \*\*Availability:\*\* The dataset is still being curated, however you can reach out.

# \## Benchmark Results

# 

# We evaluated several existing Igbo ASR models on our dataset to establish a performance baseline. The `CLEAR-Global/w2v-bert-2.0-igbo\_naijavoices\_250h` model, fine-tuned on a large corpus of diverse Nigerian voices, achieved the best results.
...
# The notebook `Ehugbo\_ASR\_Evals.ipynb` contains the code used for the evaluation. To run it, you will need to:
...
# &nbsp;   \*   Modify the `AUDIO\_DIR` and CSV path variables in the notebook to point to your local data directories.
